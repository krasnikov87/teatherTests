...
$answerTpl = $modx->getOption('answerTpl', $scriptProperties, 'tpl.teacherTest.outerTpl');
...
$q->select($modx->getSelectColumns('teachersTestQuestion', 'teachersTestQuestion', '', ['id', 'question']));
$q->limit(1);
$q->sortby('RAND()');
$q->prepare();
